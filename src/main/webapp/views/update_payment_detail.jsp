...
<head>
    ...
    <title>Update payment details | MmaMoriri</title>
    ...
    <div class="list_them container">
         <h1>Update Payment Details</h1>
             <form action="UpdatePayment" method="post" enctype="multipart/form-data">
                 <label for="appRefNo">Appointment Reference Number:</label><br>
                 ...
                 <label for="totAmtPaid">Enter total payment:</label><br>
                 <input type="number" id="totAmtPaid" name="totAmtPaid"><br><br>
