...
<html>
    ...
    <main>
        <h1 class="text-center">Finalise Making Appointment</h1>
        <form action="SaveSucceeded" method="GET">
            ...
            <div class="box d-flex justify-content-center">
                ...
                <div class="content_in_box">
                    ...
                    <div class="container-fluid d-flex justify-content-center">
                        <a href="#"><button type="submit" class="btn btn-primary" id="create_appointment">Create</button></a>
                    </div>
                </div>
            </div>
        </div>
